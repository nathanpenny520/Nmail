...
| **v0.4.x 对外 API Skill 化** | P1 API 补全（搜索过滤/回复转发草稿/正文三选一/草稿附件/watch 游标/错误 envelope+Retry-After） · P2 nmail-cli（uvx 分发/exit code 契约/CLI 两阶段确认） · P3 SKILL.md 分发（skills/ + `npx skills add`） | 🚧 P1 完成（REDESIGN_PLAN §19，2026-09-15）；P2/P3 未开始 |
