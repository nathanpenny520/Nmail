...
| **远期** | 自动助理 / agent mail、PII 脱敏、主密码加密、MCP 接口 | ⬜ 未开始（Gmail/Outlook OAuth2 已于 2026-09-11 以用户自建 OAuth 客户端方式落地，见 CHANGELOG 与 docs/自建邮箱客户端 Gmail+Outlook OAuth2 完整教程.md） |
