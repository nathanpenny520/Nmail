...
**v0.4 改版（2026-09-12 定稿）**：导航重设计（砍侧栏、邮件基座+小按钮开页签）、文件管理器式邮件、每账号服务器端 Archived 归档、草稿体系合并、通讯录、AI 总管家 2.0（审批/自动双模式）、对外 API、内置 OAuth 快速授权、官网 nmail.whizzzest.com——完整方案与决策记录（D1–D7）见 [REDESIGN_PLAN.md](REDESIGN_PLAN.md)，落地按其 §13 P1–P8 推进。本文档以下条目已被 v0.4 修订：§2 原则 1（通讯录）、§3.4（自动助理提前）、§8 路线图、§10 决策 1/2（归档语义与自动助理）。
**当前进度（2026-09-11）**：P0–P3 全部完成并经真实账号验证；P4 进行中（UI 密度分屏拖拽/字号系统/总管家/会话持久化/AI 配置档案多模型/服务商自动探测/打包分发/应用内更新检查+winget·Homebrew 渠道已落地，v0.1.0 已发布 PyPI 与 Release）；远期项未开始。
