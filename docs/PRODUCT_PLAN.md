...
**当前进度（2026-09-13）**：v0.4 改版 P1–P8 主体已落地并随 v0.3.0 发布（2026-09-12，PyPI / Homebrew / GitHub Release）；发布后持续收尾打磨（品牌区与树折叠、FLAGS 对账、代理跟随系统、新用户初始化定版等，见 [CHANGELOG.md](CHANGELOG.md)）；远期项未开始。
...
| **远期** | 自动助理 / agent mail、PII 脱敏、主密码加密、MCP 接口 | ⬜ 未开始（Gmail/Outlook OAuth2 已于 2026-09-11 以用户自建 OAuth 客户端方式落地，见 CHANGELOG 与 docs/自建邮箱客户端 Gmail+Outlook OAuth2 完整教程.md）。自动助理与 MCP 分别由 v0.4 的 P6（AI 2.0）与 P7（对外 API 为其基座）承接 |
| **v0.4 改版** | P1 导航骨架（砍侧栏）+字号统一 · P2 资源管理器（文件夹树/拖拽/按需同步）+每账号服务器归档 · P3 草稿体系合并 · P4 通讯录 · P5 OAuth 内置凭证快速授权 · P6 AI 总管家 2.0（工具+审批/自动） · P7 对外 API · P8 官网 | 📋 已定稿（REDESIGN_PLAN §13），待开工 |
