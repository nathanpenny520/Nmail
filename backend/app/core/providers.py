...
_PRESET_ROWS: list[tuple[str, tuple[str, ...], str, int, str, int, str]] = [
    ...
    ("Gmail", ("gmail.com", "googlemail.com"),
     ...
     "Google 已停用密码直连：推荐使用 OAuth2 授权登录（先在 设置-邮箱账号-OAuth2 配置 Google client_id，添加账号时点「使用 Google 账号授权」）"),
    ("Outlook / Hotmail", ("outlook.com", "hotmail.com", "live.com", "msn.com"),
     "outlook.office365.com", 993, "smtp.office365.com", 587,
     "Microsoft 已停用基础密码认证：推荐使用 OAuth2 授权登录（先在 设置-邮箱账号-OAuth2 配置 Microsoft client_id）；个人账号还需在 Outlook 网页版 设置-邮件-同步电子邮件 开启 POP/IMAP 与经过身份验证的 SMTP"),
